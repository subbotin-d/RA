object WorkShop01 {
    ...
    fun compareTwoInts(num3: Int, num4: Int, lambda: (Int, Int) -> Boolean): Boolean {
        val result = lambda(num3, num4)
        return result
    }
    ...
    fun checkNumInRange(num: Int): String {
        return when (num) {
            ...
            in 2..100 -> "Число $num принадлежит интервалу (3; 100]"
